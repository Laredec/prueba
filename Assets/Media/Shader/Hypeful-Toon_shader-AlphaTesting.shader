Shader "Hypeful/Toon Shader - Alpha Testing" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            fixed4 frag(VertexOutput i) : COLOR {
                fixed4 _alpha_map_var = tex2D(_alpha_map,TRANSFORM_TEX(i.uv0, _alpha_map));
                fixed alpha_mask = _alpha_map_var.r;
                clip(alpha_mask - 0.5);
        ...
        Pass {
            ...
            fixed4 frag(VertexOutput i) : COLOR {
				...
				fixed alpha_mask = tex2D(_alpha_map,TRANSFORM_TEX(i.uv0, _alpha_map)).r;
				clip(alpha_mask - 0.5);
